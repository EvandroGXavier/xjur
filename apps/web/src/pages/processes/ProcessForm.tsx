    ...
    return (
        <div className="w-full min-h-full p-4 md:p-6 xl:p-8 animate-in fade-in">
            ...
            {(isEditing || importedParties.length > 0 || importedMovements.length > 0) && (
                <div className="mb-6 flex overflow-x-auto border-b border-slate-800 scroller-hidden">
            ...
            <div className="w-full min-w-0">
                ...
                <div className={activeTab === 'MAIN' ? 'block' : 'hidden'}>
                    <form onSubmit={e => { e.preventDefault(); void handleSubmit(true); }} className="w-full space-y-6">
