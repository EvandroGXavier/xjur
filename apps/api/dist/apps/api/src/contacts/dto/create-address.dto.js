...
__decorate([
    ...
    (0, class_validator_1.MinLength)(3, { message: 'Logradouro deve ter pelo menos 3 caracteres' }),
...
__decorate([
    ...
    (0, class_validator_1.MaxLength)(2, { message: 'Estado deve ter 2 caracteres' }),
    __metadata("design:type", String)
